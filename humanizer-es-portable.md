# HUMANIZER-ES, versión portátil

> **Para qué es esto.** La misma skill en una sola pieza, para pegar en cualquier
> sitio que no sea Claude Code: las instrucciones personalizadas de ChatGPT, un
> proyecto, un gem de Gemini, o directamente al principio de una conversación.
>
> Rellena la sección del perfil de voz antes de usarlo. Sin eso, hace los pasos 1 y 2
> (quitar patrones de IA y arreglar el español) pero no el 3.
>
